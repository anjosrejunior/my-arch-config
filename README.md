...
* **Package Manager (`pacman.conf`):** Parallel downloads enabled (10) and the `ILoveCandy` easter egg activated 🕹️.
* **Audio (`pavucontrol`):** PulseAudio/PipeWire volume control configurations.
* Work in progress / Still writing...
